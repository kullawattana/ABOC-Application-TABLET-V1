 ...
 */
public class MainFragmentNavigationDrawer extends Fragment implements OnClickListener {

    private boolean mSearchCheck;
    private static final String TEXT_FRAGMENT = "TEXT_FRAGMENT";

	public static MainFragmentNavigationDrawer newInstance(String text){
		MainFragmentNavigationDrawer mFragment = new MainFragmentNavigationDrawer();
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_search:
			...
			Intent fdActivityClass = new Intent(getContext(),MainActivityAddEBook.class);			        //เปิด Module facerecognition
