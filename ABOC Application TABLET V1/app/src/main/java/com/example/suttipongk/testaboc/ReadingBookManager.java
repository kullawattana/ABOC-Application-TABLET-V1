...
public class ReadingBookManager extends AppCompatActivity {
    ...
    ImageButton micฺButton = null;
    ImageButton buttonRight = null;

    ImageView book = null;
    AlphaAnimation bookIcon = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonLeft = (ImageButton) findViewById (R.id.imageButtonControlPageLeft);
        micฺButton = (ImageButton) findViewById (R.id.imageButtonControlPageVoice);
        buttonRight = (ImageButton) findViewById (R.id.imageButtonControlPageRight);

        //Animation
        animLeft = new AlphaAnimation(1, 0);       // Change alpha from fully visible to invisible
        animRight = new AlphaAnimation(1, 0);
        bookIcon = new AlphaAnimation(1, 0);
        ...
        bookIcon.setInterpolator(new LinearInterpolator());
        bookIcon.setRepeatCount(Animation.INFINITE);                    //Repeat animation
        bookIcon.setDuration(1000);

        book.startAnimation(bookIcon);                                  //start light icon
        ...
        micฺButton.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View arg0) {
                //เปิด Popup อ่านเสียง สั่ง Motor เพื่อเปิดอ่านหนังสือ
            ...
            case RESULT_SPEECH: {
                if (resultCode == RESULT_OK && null != data) {
                    ...
                    if(falado.equals("previous")){
                        ...
                        voiceCommand = "b";                             //Sent "a" to bluetooth
